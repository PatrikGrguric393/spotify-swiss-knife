...
/// <summary>
/// Shared, validated request body for creating or updating a track via the API. Backs both
/// <see cref="TrackCreateDto"/> and <see cref="TrackUpdateDto"/>.
/// </summary>
public abstract class TrackWriteDto
{
