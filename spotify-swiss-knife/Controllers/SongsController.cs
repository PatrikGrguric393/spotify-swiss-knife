...
public class SongsController : Controller
{
    ...
    public SongsController(TrackRepository trackRepository, ArtistRepository artistRepository)
    {
    ...
    public IActionResult CreateSong()
    {
        ...
        return View(new Models.FormModels.TrackCreateModel());
    }
    ...
    public IActionResult EditSong(string id)
    {
        ...
        return View(new Models.FormModels.TrackEditModel
        {
            Id = track.Id,
            Name = track.Name,
